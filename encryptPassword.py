...
def add_password():
    ...
    try:
        ...
        username, hashed_key, salt, id_service, services = load_data("passwordManager.json")
        ...
        save_password_data_to_file(username, json_file, id_service, service, email, encrypted_password)
